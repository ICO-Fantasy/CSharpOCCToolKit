...
public class Pipe {
    ...
    /// 截面形状
    /// </summary>
    public TShape? CrossSectionShape { get; set; }
    ...
    #region Function
    public void CalculatePipeLengthFromYBC() {
    if (ybcr.Count == 0)
        pipeLength = 0.0;
    }

    public void XYZR2YBCR() {
    ybcr.Clear();
    if (xyzr.Count < 3) {
    ...
    /// 3. 第三点的Y为正，Z为0
    /// </summary>
    public void XYZR2StandardXYZR() { }

    public void makeWireFromYBC() {
    MakeWire maker = new();
