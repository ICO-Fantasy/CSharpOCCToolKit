...
public value struct Ax2 :System::ICloneable, System::Runtime::Serialization::ISerializable {
public:
...
public:
    ...
    // 用于反序列化的构造函数
    Ax2(System::Runtime::Serialization::SerializationInfo^ info, System::Runtime::Serialization::StreamingContext context);
public:
